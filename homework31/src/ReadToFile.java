...
public class ReadToFile {
    ...
    public void result() {
        ...
        System.out.println("Текст : " + textFile);
        ...
        System.out.println("Числа : " + beforeDelete.toString());
        System.out.println("Сумма чисел: " + sum);
        System.out.println("Числа в тексте после удаления одинаковых: " + afterDelete.toString());
